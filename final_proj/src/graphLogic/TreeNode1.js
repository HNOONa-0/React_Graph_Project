...
const makechildren = (
  ...
  for (const next of adjacencyList[curIndex]) {
    ...
    i++;
    children.push(
      new TreeNode1(curParent, curDepth + 1, i, next, adjacencyList, visited)
    );
  }
  return children;
};
export class TreeNode1 {
  ...
  static buildTree(
    ...
    let root = new TreeNode1(0, 0, 1, idx, adjacencyList, visited);
...
//     this.x = -1;
//     this.y = depth;
//     this.children = [...adjacencyList[idx]].filter(e => e !== fromIdx).map((e, i) => new TreeNode1(this, depth + 1, i + 1, e, idx, adjacencyList));
...
//     this.idx = idx;
// }
// let root = new TreeNode1(0, 0, 1, 1, 0, adjacencyList);
